...
let CreateConversationDto = (() => {
    ...
    return class CreateConversationDto {
        ...
        memberIds = (__runInitializers(this, _avatarUrl_extraInitializers), __runInitializers(this, _memberIds_initializers, void 0));
        constructor() {
            __runInitializers(this, _memberIds_extraInitializers);
        }
    };
})();
