...
let AuthController = (() => {
    ...
    var AuthController = class {
        ...
        static {
            ...
            _refresh_decorators = [Post('refresh')];
            _logout_decorators = [UseGuards(JwtAuthGuard), ApiBearerAuth(), Post('logout')];
            _forgotPassword_decorators = [Post('forgot-password')];
            _resetPassword_decorators = [Post('reset-password')];
