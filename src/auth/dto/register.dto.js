...
let RegisterDto = (() => {
    ...
    return class RegisterDto {
        static {
            ...
            _displayName_decorators = [IsString()];
        ...
        phoneNumber = (__runInitializers(this, _displayName_extraInitializers), __runInitializers(this, _phoneNumber_initializers, void 0));
        constructor() {
